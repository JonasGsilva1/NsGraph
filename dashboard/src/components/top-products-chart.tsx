...
import type { TopProduct } from "@/lib/api-hooks";
...
export function TopProductsChart({ data }: TopProductsChartProps) {
  ...
  return (
    <div className="chart-card animate-fade-in-delay-2 flex flex-col h-[400px]">
      <h3 className="font-semibold text-lg mb-1">Top produtos</h3>
